...
<?php endif; ?>
<?php if (sizeof($fobas) > 0): ?>
    <div class="alert alert-info">
        <p>Tenés que elegir una nueva carrera <b>IMP, PMIP o PEM.</b></p>
        <p><a href="/alumno-carrera" class="btn btn-info btn-sm pull-right">Anotarme ahora!!!</a></p>
        <br/>
    </div>
<?php endif; ?>
<?php if (sizeof($avanzadas) > 0): ?>
    <?php foreach ($avanzadas as $key => $carrera) : ?>
        <div class="alert alert-info">
            <p>Tenés que elegir un area para la carrera <b><?php echo $carrera["cdescripcion"]; ?>.</b></p>
            <p><a href="/alumno-carrera" class="btn btn-info btn-sm pull-right">Elegir ahora!!!</a></p>
            <br/>
        </div>
    <?php endforeach; ?>
<?php endif; ?>
