...
<html lang="es">
    <head>
        ...
        <title><?php echo($this->POROTO->Config['empresa_descripcion']);?> - RENTACAR -</title>
    ...
    <body>
        <div class="container">
            <div class="page-header text-center">
                <h1><?php echo($this->POROTO->Config['empresa_nombre']);?></h1>
                <h2><?php echo($this->POROTO->Config['empresa_descripcion']);?></h2>
            </div>
        ...
        <div class="footer">
            diseñado y desarrollado por Soft x
        </div>
