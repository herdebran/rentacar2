...
<form class="form-horizontal" action="#" id="form-busqueda"
    ...
    <fieldset>
        <h3>Búsqueda de Unidades Funcionales</h3>
        ...
        <div class="form-group col-xs-12 col-sm-6 col-lg-4">
            ...
            <div class="col-xs-8">
                <select class="form-control" id="fideicomiso" name="fideicomiso">
                    <option value="0">SELECCIONAR</option>
                    <?php foreach ($params['viewDataFideicomiso'] as $fideicomiso) { ?>
                        <option value="<?php echo $fideicomiso['idfideicomiso']; ?>"><?php echo $fideicomiso['descripcion']; ?></option>
                    <?php } ?>
                </select>
            </div>
        </div>        
        ...
        <div class="form-group col-xs-12 col-sm-6 col-lg-4">
            ...
            <div class="col-xs-8">
                <select class="form-control" id="tipo" name="tipo">
                    <option value="0">SELECCIONAR</option>
                    <?php foreach ($params['viewDataTipoUF'] as $tipo) { ?>
        ...
        <div class="form-group">
            <div class="col-xs-12">
                ...
                <a href="/crearunidadfuncional" class="btn btn-success pull-right">Crear Unidad funcional</a>
            </div>
        </div>
    </fieldset>
</form>
...
// Verifica si existe una busqueda previa y si la hay la carga en el formulario.
        if (sessionStorage.getItem('busqueda') !== null) {
            ...
            $("#fideicomiso").val(oldSearch.fideicomiso);
        }
        // DATATABLE------------------------------------------------------------------------//
        ...
        function cargarDataTable() {
            ...
            table = $('#table-resultados')
                    ...
                    .DataTable({
                        ...
                        scrollX: true,
                        ajax: {
                            url: "/unidadfuncional/unidadesfuncionalesConFiltro",
                            method: "post",
                            data: function (data) {
                                data = {};
                                data.tipo = $("#tipo").val();
                                ...
                                data.fideicomiso = $("#fideicomiso").val();
