...
<html lang="es">
    ...
    <body>
        ...
        <nav class="navbar navbar-empa navbar-fixed-top empa-top"  
            <?php if ($_SERVER['Entorno'] != "PRODUCCION" && $this->POROTO->Config['empresa_nombre']=='EMPA') { echo "style='background: ".$this->POROTO->Config['empresa_color_header_desarrollo']."'";}
                  if ($_SERVER['Entorno'] != "PRODUCCION" && $this->POROTO->Config['empresa_nombre']!='EMPA') { echo "style='background: ".$this->POROTO->Config['empresa_color_header_desarrollo']."'";}
            ?>>
            <div class="container">
                <div class="navbar-header">
                    ...
                    <?php if($this->POROTO->Config['empresa_nombre']=='EMPA'){ ?>
                        <a class="" href="/ "><img src="/images/<?php echo $this->POROTO->Config['empresa_minilogo']; ?>"  style="margin-right: 20px; margin-top: -3px" /></a>
                    <?php }else{ ?>
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown">
                            <a class="disabled">Tiempo para finalizar la sesion <b data-time="<?php echo $this->POROTO->Config['session_minutes_alive'] * 60000 ?>" class="disabled" id="relojito"></b></a>
                        </li>
                        <?php if ($this->POROTO->Config['show_user_role_at_menu']) { ?>
                            <li class="active"><a href="#">_.-:<?php echo $ses->getRoleName(); ?>:-._</a></li>
                        <?php } ?>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="javascript: window.location.href='/';">Inicio</a></li>
                                <li><a href="javascript: sessionStorage.clear(); window.location.href='/logout';">Cerrar Sesión</a></li>
                            </ul>
                        </li>
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
