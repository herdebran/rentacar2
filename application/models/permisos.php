...
class ModeloPermisos {
    ...
    public function getUsuarioByIdPersona($idpersona) {
        $sql = "select * from usuarios where idpersona = :idpersona";
    ...
    public function getPermisosDeRol($idrol) {
        $sql = "select * from permisosroles where idrol = :idrol";
    ...
    public function getPermisosAsignados($idpersona) {
        $sql = "select distinct idpersona,idpermiso,'' as rol from personapermisos where idpersona = :idpersona
                union all
