...
class Fideicomiso extends Controller {
    ...
    public function crearfideicomiso($idfideicomiso = null) { 
        ...
        if (isset($_POST['descripcion'])) {
            ...
            $dataDiaSegundoVenc=isset($_POST['segundovencdia']) ? $db->dbEscape(trim(intval($_POST['segundovencdia']))) : "0";
            ...
            $dataDiaTercerVenc=isset($_POST['tercervencdia']) ? $db->dbEscape(trim(intval($_POST['tercervencdia']))) : "0"; 
